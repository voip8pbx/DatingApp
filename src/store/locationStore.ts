...
interface LocationStore {
    ...
    setMatchedLocations: (locs: MatchedUserLocation[] | ((prev: MatchedUserLocation[]) => MatchedUserLocation[])) => void;
...
export const useLocationStore = create<LocationStore>((set) => ({
    ...
    setMatchedLocations: (locs) => set((state) => ({
        matchedLocations: typeof locs === 'function' ? locs(state.matchedLocations) : locs
    })),
